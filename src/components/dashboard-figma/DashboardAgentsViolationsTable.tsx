...
const AGENT_ROWS = [
  { avatar: 'CC', name: 'customer-care', framework: 'LangChain · langgraph.checkpoint.sqlite', blocked: 847 },
  { avatar: 'DR', name: 'deploy-runner', framework: 'CrewAI · task delegation', blocked: 612 },
  { avatar: 'CR', name: 'code-reviewer', framework: 'OpenClaw · tool.http.request', blocked: 203 },
] as const
              ...
              <div className="relative flex shrink-0 items-center gap-[12px]">
                ...
                <div className="relative flex shrink-0 items-center gap-[4px]">
                  <p className="relative shrink-0 whitespace-nowrap font-['Inter:Semibold',sans-serif] text-[12px] leading-[18px] not-italic text-[color:var(--Colors/Text/text-primary(900),#181d27)]">
                    Agents with most guardrail blocks
                  </p>
                </div>
              </div>
            </div>
