    ...
    >
              ...
              <div className="relative flex shrink-0 items-center gap-[12px]" data-name="Header Title">
                ...
                <div className="relative flex shrink-0 items-center gap-[4px]">
                  <p className="relative shrink-0 whitespace-nowrap font-['Inter:Semibold',sans-serif] text-[12px] leading-[18px] not-italic text-[color:var(--Colors/Text/text-primary(900),#181d27)]">
                    Users with Most Violations in Agent Coding Sessions
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="relative z-[1] flex w-full shrink-0 items-start" data-name="Content">
        <div className="relative flex min-h-px min-w-px flex-[1_0_0] flex-col items-start isolate" data-name="Column">
          ...
          <div
            className="relative z-[3] flex h-[50px] w-full shrink-0 cursor-pointer items-center gap-[var(--spacing-lg,12px)] border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
          ...
          >
            <div className="relative size-[40px] shrink-0 rounded-[var(--radius-full,9999px)] border border-[rgba(0,0,0,0.08)] border-solid">
              <div aria-hidden className="pointer-events-none absolute inset-0 rounded-[var(--radius-full,9999px)]">
                <div className="absolute inset-0 rounded-[var(--radius-full,9999px)] bg-[#cfcbdc]" />
                <img
                  alt=""
          ...
          <div
            className="relative z-[2] flex h-[50px] w-full shrink-0 cursor-pointer items-center gap-[var(--spacing-lg,12px)] border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
            data-name="Table cell"
          >
            <div className="relative size-[40px] shrink-0 rounded-[var(--radius-full,9999px)] border border-[rgba(0,0,0,0.08)] border-solid">
              <div aria-hidden className="pointer-events-none absolute inset-0 rounded-[var(--radius-full,9999px)]">
                <div className="absolute inset-0 rounded-[var(--radius-full,9999px)] bg-[#d6cfb7]" />
                <img
                  alt=""
                  className="absolute size-full max-w-none rounded-[var(--radius-full,9999px)] object-cover"
                  src={imgAvatar1}
          ...
          <div
            className="relative z-[1] flex h-[50px] w-full shrink-0 cursor-pointer items-center gap-[var(--spacing-lg,12px)] border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
            data-name="Table cell"
          >
            <div className="relative size-[40px] shrink-0 rounded-[var(--radius-full,9999px)] border border-[rgba(0,0,0,0.08)] border-solid">
              <div aria-hidden className="pointer-events-none absolute inset-0 rounded-[var(--radius-full,9999px)]">
                <div className="absolute inset-0 rounded-[var(--radius-full,9999px)] bg-[#d7e3e8]" />
                <img
                  alt=""
                  className="absolute size-full max-w-none rounded-[var(--radius-full,9999px)] object-cover"
                  src={imgAvatar2}
        ...
        <div className="relative flex w-[176px] shrink-0 flex-col items-start isolate" data-name="Column">
          ...
          <div
            className="relative z-[3] flex h-[50px] w-full shrink-0 items-center border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
            data-name="Table cell"
          >
          ...
          <div
            className="relative z-[2] flex h-[50px] w-full shrink-0 items-center border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
            data-name="Table cell"
          >
            <div className="relative flex shrink-0 items-center rounded-[var(--radius-full,9999px)] border border-[var(--component-colors\/utility\/error\/utility-error-200,#fecdca)] border-solid bg-[var(--component-colors\/utility\/error\/utility-error-50,#fef3f2)] px-[var(--spacing-md,8px)] py-[var(--spacing-xxs,2px)]">
              <p className="relative shrink-0 whitespace-nowrap text-center font-[family-name:var(--font-family\/font-family-body,'Inter:Medium',sans-serif)] text-[length:var(--font-size\/text-xs,12px)] font-medium leading-[var(--line-height\/text-xs,18px)] text-[color:var(--component-colors\/utility\/error\/utility-error-700,#b42318)]">
          ...
          <div
            className="relative z-[1] flex h-[50px] w-full shrink-0 items-center border-b border-[var(--colors\/border\/border-secondary,#e9eaeb)] border-solid px-[var(--spacing-3xl,24px)] py-[var(--spacing-xl,16px)] transition-colors duration-150 hover:bg-[#fafafa]"
            data-name="Table cell"
          >
            <div className="relative flex shrink-0 items-center rounded-[var(--radius-full,9999px)] border border-[var(--component-colors\/utility\/error\/utility-error-200,#fecdca)] border-solid bg-[var(--component-colors\/utility\/error\/utility-error-50,#fef3f2)] px-[var(--spacing-md,8px)] py-[var(--spacing-xxs,2px)]">
              <p className="relative shrink-0 whitespace-nowrap text-center font-[family-name:var(--font-family\/font-family-body,'Inter:Medium',sans-serif)] text-[length:var(--font-size\/text-xs,12px)] font-medium leading-[var(--line-height\/text-xs,18px)] text-[color:var(--component-colors\/utility\/error\/utility-error-700,#b42318)]">
